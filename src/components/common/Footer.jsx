    ...
    <footer className="w-full bg-white px-6 py-4 dark:bg-black sm:px-14 sm:py-6">
      <div className="md:mr-10 md:flex md:justify-between">
        <div className="-ml-1 mb-6 md:mb-0">
          <Link className="flex items-center" to="/">
            <img alt="Coderz Logo" className="mr-1 h-8 rounded-full sm:h-9" src={logo} />
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              className="hover:underline"
              href="https://www.linkedin.com/in/rakan-abunamoos-19a009154/"
              rel="noopener noreferrer"
              target="_blank"
            >
              LinkedIn
      ...
      <div className="flex flex-col justify-center text-sm md:mr-10 md:flex-row md:items-center md:justify-between">
        ...
        <div className="mx-auto mt-4 flex w-fit space-x-6 sm:justify-center md:mx-0 md:mt-0">
          <a href="https://www.facebook.com/rakan.sami.79" rel="noopener noreferrer" target="_blank">
          ...
          <a href="https://www.instagram.com/r_72ar" rel="noopener noreferrer" target="_blank">
            <svg aria-hidden="true" className="h-5 w-5 dark:fill-white" viewBox="0 0 24 24">
              <path
                clipRule="evenodd"
          ...
          <a href="https://twitter.com/rakansami123" rel="noopener noreferrer" target="_blank">
            <svg aria-hidden="true" className="h-5 w-5 dark:fill-white" viewBox="0 0 24 24">
              <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
            </svg>
            <span className="sr-only">Twitter</span>
          </a>
          <a href="https://github.com/Rakoon23" rel="noopener noreferrer" target="_blank">
            <svg aria-hidden="true" className="h-5 w-5 dark:fill-white" viewBox="0 0 24 24">
              <path
                clipRule="evenodd"
